...
public class SubjectInfoCard extends Card {

    private Subject mSubject;

    public SubjectInfoCard(Context context, Subject subject) {
        this(context, R.layout.card_subject_info, subject);
    }

    public SubjectInfoCard(Context context, int innerLayout, Subject subject) {
